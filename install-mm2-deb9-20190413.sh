#!/bin/bash
VERSION=modesmixer2_rpi2-3_deb9_20190413
INSTALL_FOLDER=/usr/share/mm2

echo "Creating folder mm2"
sudo mkdir ${INSTALL_FOLDER}
echo "Downloading modeSMixer2 file from Google Drive"
sudo wget -O ${INSTALL_FOLDER}/${VERSION}.tgz "https://drive.google.com/uc?export=download&id=1YvXOE7tlhtMocmQQBZ7VtW8AN_3oPleF"
