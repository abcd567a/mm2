...
echo -e "\e[32m=======================\e[39m"
echo -e "\e[32m(1) In yiur browser, go to web interface at\e[39m http://$(ip route | grep -m1 -o -P 'src \K[0-9,.]*'):8787"
echo " "
echo -e "\e[33m(2) Open file mm2.conf for editing by following command:\e[39m"
echo ""
echo -e "\e[39msudo nano "${INSTALL_FOLDER}"/mm2.conf \e[39m"
echo ""
